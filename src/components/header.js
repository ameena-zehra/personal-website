    ...
    <Navbar expand ="sm">
        ...
        <Navbar.Collapse id = "navbarResponsive">
          <Nav as ="ul" className = "ml-auto">
            ...
            <Nav.Item as ="li">
              <Link to="https://drive.google.com/file/d/19uIS-s9CQ0KIykBQKzwqK8ycEOS_arKL/view?usp=sharing" className = "notosanstext nav-text" activeClassName ="active"> resume</Link>
            </Nav.Item>
          </Nav>
        </Navbar.Collapse>
      </Navbar>
